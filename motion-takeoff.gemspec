...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{A RubyMotion specific iOS gem that helps you schedule things.}
  spec.summary       = %q{A RubyMotion specific iOS gem that helps you schedule things. You can use this gem to display messages at certain launch counts and schedule local notifications.}
